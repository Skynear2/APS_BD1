...
CREATE TABLE IF NOT EXISTS `Funcionarios` (
  ...
  `descricaoLiga` VARCHAR(150) NOT NULL,
  PRIMARY KEY (`idLiga`),
  UNIQUE (`nomeLiga`));
  ...
  CREATE TABLE IF NOT EXISTS `Clube_has_Partida` (
  `Clube_Casa` INT NOT NULL,
  `Clube_Visitante` INT NOT NULL,
  `Partida_idPartida` INT NOT NULL,
  `Liga_idLiga` INT NOT NULL,
  PRIMARY KEY (`Clube_Casa`, `Clube_Visitante`, `Liga_idLiga`),
  FOREIGN KEY (`Clube_Casa`) REFERENCES `Clubes` (`idClube`),
  FOREIGN KEY (`Clube_Visitante`)REFERENCES `Clubes` (`idClube`),
  FOREIGN KEY (`Partida_idPartida`) REFERENCES `Partida` (`idPartida`),
  FOREIGN KEY (`Liga_idLiga`) REFERENCES `Liga` (`idLiga`));
  

INSERT INTO `endereco` (`idEndereco`, `cepEndereco`, `numeroEndereco`, `ruaEndereco`) VALUES ('10', '87302090', '1270', 'Brasil');
INSERT INTO `endereco` (`idEndereco`, `cepEndereco`, `numeroEndereco`, `ruaEndereco`) VALUES ('11', '90834980', '78', 'Brasil');
INSERT INTO `endereco` (`idEndereco`, `cepEndereco`, `numeroEndereco`, `ruaEndereco`) VALUES ('12', '78904216', '56', 'Brasil');
INSERT INTO `endereco` (`idEndereco`, `cepEndereco`, `numeroEndereco`, `ruaEndereco`) VALUES ('13', '87895572', '5780', 'Brasil');
INSERT INTO `endereco` (`idEndereco`, `cepEndereco`, `numeroEndereco`, `ruaEndereco`) VALUES ('14', '56784299', '259', 'Brasil');
INSERT INTO `endereco` (`idEndereco`, `cepEndereco`, `numeroEndereco`, `ruaEndereco`) VALUES ('15', '10568922', '689', 'Brasil');
INSERT INTO `endereco` (`idEndereco`, `cepEndereco`, `numeroEndereco`, `ruaEndereco`) VALUES ('16', '45789022', '345', 'Brasil');
INSERT INTO `endereco` (`idEndereco`, `cepEndereco`, `numeroEndereco`, `ruaEndereco`) VALUES ('17', '23478654', '120', 'Brasil');
INSERT INTO `endereco` (`idEndereco`, `cepEndereco`, `numeroEndereco`, `ruaEndereco`) VALUES ('18', '12639880', '2485', 'Brasil');
INSERT INTO `endereco` (`idEndereco`, `cepEndereco`, `numeroEndereco`, `ruaEndereco`) VALUES ('19', '45899521', '750', 'Brasil');
INSERT INTO `endereco` (`idEndereco`, `cepEndereco`, `numeroEndereco`, `ruaEndereco`) VALUES ('20', '45878451', '650', 'Brasil');
INSERT INTO `endereco` (`idEndereco`, `cepEndereco`, `numeroEndereco`, `ruaEndereco`) VALUES ('21', '12589022', '1650', 'Brasil');
INSERT INTO `endereco` (`idEndereco`, `cepEndereco`, `numeroEndereco`, `ruaEndereco`) VALUES ('22', '45878451', '3870', 'Brasil');
INSERT INTO `endereco` (`idEndereco`, `cepEndereco`, `numeroEndereco`, `ruaEndereco`) VALUES ('23', '39895512', '2465', 'Brasil');
INSERT INTO `endereco` (`idEndereco`, `cepEndereco`, `numeroEndereco`, `ruaEndereco`) VALUES ('24', '55863471', '526', 'Brasil');
INSERT INTO `endereco` (`idEndereco`, `cepEndereco`, `numeroEndereco`, `ruaEndereco`) VALUES ('25', '22879641', '860', 'Brasil');
INSERT INTO `endereco` (`idEndereco`, `cepEndereco`, `numeroEndereco`, `ruaEndereco`) VALUES ('26', '14678290', '1260', 'Brasil');
INSERT INTO `endereco` (`idEndereco`, `cepEndereco`, `numeroEndereco`, `ruaEndereco`) VALUES ('27', '63574498', '4563', 'Brasil');
...
INSERT INTO `liga` (`idLiga`, `nomeLiga`, `descricaoLiga`) VALUES ('10', 'teste', 'teste');

INSERT INTO `partida` (`idPartida`, `dataPartida`) VALUES ('10', '01/01/1999');
INSERT INTO `partida` (`idPartida`, `dataPartida`) VALUES ('11', '02/02/1999');

INSERT INTO `clube_has_partida` (`Clube_Casa`, `Clube_Visitante`, `Partida_idPartida`, `Liga_idLiga`) VALUES ('10', '11', '10', '10');
INSERT INTO `clube_has_partida` (`Clube_Casa`, `Clube_Visitante`, `Partida_idPartida`, `Liga_idLiga`) VALUES ('11', '10', '11', '10');
