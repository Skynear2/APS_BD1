<html>
	<head>
            <title> FIFINHA </TITLE>
            <link rel="stylesheet" type="text/css" href="..\css\JogadoresCss.css" />
	</head>
        <?php
	...
	<body>
            <?php
            if($opcao == '1'){?>
                <form action="..\editar\editarJogador.php" method="post">
                            <div id="titulo">
                                    <label> Jogador </label>
                            </div>	
                            <div id="opcao">
            ...
            <?php }
                ...
                ?>
            <form action="..\excluir\excluirJogador.php" method="post">
                            <div id="titulo">
                                    <label> Jogador </label>
                            </div>	
                            <div id="opcao">
